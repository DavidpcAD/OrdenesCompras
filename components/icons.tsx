...
// El DS tampoco tiene "descargar" (su set es de estados y objetos, no de acciones
// de archivo). Es el mismo dibujo del botón Exportar de las tablas, para que bajar
// algo se vea igual en toda la app.
export const IconDescargar = ({ size = 18, ...p }: P) => (

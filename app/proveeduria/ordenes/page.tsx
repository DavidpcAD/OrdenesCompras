        ...
        <Card className="mt-6" style={{ padding: 0, overflow: "hidden" }}>
          <div className="ds-table-wrap" style={{ boxShadow: "none" }}>
            <table className="ds-table">
              <thead>
                <tr><th>N.º</th><th>Proveedor</th><th>Fecha</th><th className="ds-num">Total</th><th>Recibido</th><th>Estado</th><th></th></tr>
              </thead>
              <tbody>
                {ordenes.length === 0 && <tr><td colSpan={7}><div className="empty">Aún no hay órdenes.</div></td></tr>}
                {ordenes.map((o) => {
